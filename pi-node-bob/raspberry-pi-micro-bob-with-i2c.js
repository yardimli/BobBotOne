...
var motor_hat = new Adafruit_MotorHAT(0x6f);
...
var myMotorLeft = motor_hat.getMotor(1);
var myMotorRight = motor_hat.getMotor(2);
...
//    if (filePath === './webserver') filePath = './webserver/index.html';
    ...
    //--------------------------------------------------------------------------------------------------------------
      ...
      if (query.operation === "motion") {
        ...
        if (query.motor_left === "on") {
          if (query.motor_left_direction === "fwd") {
            myMotorLeft.run(Adafruit_MotorHAT.BACKWARD);
          }
          else if (query.motor_left_direction === "bkw") {
            myMotorLeft.run(Adafruit_MotorHAT.FORWARD);
          }
          if (query.motor_left_speed === "0" {
            myMotorLeft.setSpeed(0);
            myMotorLeft.run(Adafruit_MotorHAT.RELEASE);
          }
          else {
            myMotorLeft.setSpeed(query.motor_left_speed);
          }
        }
        else {
          myMotorLeft.setSpeed(0);
        ...
        if (query.motor_right === "on") {
          if (query.motor_right_direction === "fwd") {
            myMotorRight.run(Adafruit_MotorHAT.BACKWARD);
          }
          else if (query.motor_right_direction === "bkw") {
            myMotorRight.run(Adafruit_MotorHAT.FORWARD);
          }
          if (query.motor_right_speed === "0" {
            myMotorRight.setSpeed(0);
            myMotorRight.run(Adafruit_MotorHAT.RELEASE);
          }
          else {
            myMotorRight.setSpeed(query.motor_right_speed);
          }
        }
        else {
          myMotorRight.setSpeed(0);
